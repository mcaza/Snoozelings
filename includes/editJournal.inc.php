...
echo '</div>';
    ...
    if ($type === "mentalHealth") {
        ...
        echo '<div class="radioBox" ><input type="radio" name="anxiety" value="1"><label for="anxiety">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="depression" value="1"><label for="depression">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="stress" value="1"><label for="stress">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="productivity" value="1"><label for="productivity">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="health" value="1"><label for="health">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="sleep" value="1"><label for="sleep">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="water" value="1"><label for="water">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="low" value="1" ><label for="low">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="high" value="1" ><label for="high">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="avg" value="1" ><label for="avg">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="activity" value="1" ><label for="activity">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="weather" value="Frozen" ><label for="weather">Frozen</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="air" value="Sickly" ><label for="air">Sickly</label></div>';
