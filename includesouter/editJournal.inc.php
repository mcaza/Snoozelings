...
echo '</div>';
    ...
    if ($type === "mentalHealth") {
        ...
        echo '<div class="radioBox" ><input type="radio" name="anxiety" value="1" id="anx1"><label for="anx1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="depression" value="1" id="dep1"><label for="dep1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
     echo '<div class="radioBox" ><input type="radio" name="stress" value="1" id="str1"><label for="str1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="sleep" value="1" id="sle1"><label for="sle1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="water" value="1" id="wat1"><label for="wat1">1</label></div>';
        ...
        echo "<form method='POST' action='includes/updatePain.inc.php' onsubmit=\"return confirm('Please confirm there is no identifying information');\">";   
        
        //Rate Lowest Pain
        echo '<label class="form" style="margin-top: 1rem;">Rate Your Lowest Pain Today:</label><br>';
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="low" value="1" id="low1"><label for="low1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="high" value="1" id="hig1"><label for="hig1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="avg" value="1" id="avg1"><label for="avg1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="activity" value="1" id="act1"><label for="act1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="weather" value="Frozen" id="frozen"><label for="frozen">Frozen</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox"><input type="radio" name="air" value="Sickly"  id="sickly"><label for="sickly">Sickly</label></div>';
    ...
    echo '<button  class="fancyButton">Submit</button>';
     echo "</form>";
        ...
        echo "<form method='POST' action='includes/updateGeneric.inc.php' onsubmit=\"return confirm('Please confirm there is no identifying information');\">";    
        echo '<h1>Ratings</h1>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="physical" value="1" id="phy1" ><label for="phy1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="emotional" value="1" id="emo1" ><label for="emo1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="spiritual" value="1" id="spi1" ><label for="spi1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="social" value="1" id="soc1" ><label for="soc1">1</label></div>';
        ...
        //Rate Anxiety
        echo '<label class="form" style="margin-top: 1rem;">Rate Your Food Health:</label><br>';
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="food" value="1" id="foo1" ><label for="foo1">1</label></div>';
        ...
        //Buttons
        echo '<div class="radioRow">';
        echo '<div class="radioBox" ><input type="radio" name="exercise" value="1" id="exe1" ><label for="exe1">1</label></div>';
        ...
        echo '<input class="input" type="text" name="goodThing" ><br>';
        
        echo '<label class="form" style="margin-top: 2rem;" for="badThing">Name One Bad Thing from Today:</label><br>';
        echo '<input class="input" type="text" name="badThing" ><br>';
