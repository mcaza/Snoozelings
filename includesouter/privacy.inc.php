...
echo '<p>We use your data for the following:<br><br>1. Internal Data Storage<br><br>2. Correspondence about your account including account activation, retrieving post passwords.<br><br>3. Your date of birth is used to check your age for registration, make sure you are 13 years or older, and deliver birthday rewards in-game.<br><br>4. IP addresses are used to monitor account activity and make sure users are following Terms of service, mainly the rules of one account per player.<br><br>5. Sleep Data is used to give rewards in-game<br><br>6. Medication data is used to give reminders to take your medication. We do not allow medication names to be entered, only categories such as "heart burn medication", "depression medication", etc. <br><br>7. Health data is used for the health journaling feature. Only the user of the journal and owners can access this data. Still, we encourage users to not include personally identifiable data within your journal.</p>';
echo '<h4>Security</h4>';
