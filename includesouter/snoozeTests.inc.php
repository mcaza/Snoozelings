...
$back = ['Braid','Forelock','Holiday','Wave'];
$front = ['Braid','Holiday','Knitted','Mohawk'];
$spine = ['LizardSpikes'];
$chest = ['Mane'];
...
//Floof Hair
if (in_array($pet['hairType'],$attached)) {
...
//Display Image
echo '<img src="snoozeImages/' . $pet['id'] . '.png?timestamp=' . $ts . '" style="width:400px;height:auto;">';
