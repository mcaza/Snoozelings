...
<body>
    ...
    <div class="body-container">
        ...
        <!-- All Main Content -->
        <div class="main-container"><div  class="bottomPush" style="display:flex;">
            <?php //Go Back Arrow
echo '<div class="leftRightButtons">';
echo '<a href="editprofile"><<</a>';
echo '</div>'; ?>
            <div id="mc_embed_shell" style="margin-left:auto;margin-right:auto;">
...
<div id="mc_embed_signup">
    <form action="https://snoozelings.us14.list-manage.com/subscribe/post?u=bd00f10336c35561599f83e2a&amp;id=5593074c95&amp;f_id=00478de0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
...
<script type="text/javascript" src="//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js"></script><script type="text/javascript">(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[5]='BIRTHDAY';ftypes[5]='birthday';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[3]='ADDRESS';ftypes[3]='address';fnames[4]='PHONE';ftypes[4]='phone';}(jQuery));var $mcj = jQuery.noConflict(true);</script></div>
