...
<body>
    ...
    <div class="body-container">
        ...
        <div class="main-container"><?php require_once '../includes/news.inc.php'; ?><div  class="bottomPush">
            <?php require_once '../includes/dyedPreviews.inc.php'; ?>
        </div></div>
    </div>
  ...
  document.getElementById('dyeColor').onchange = (event) => {
     var inputText = event.target.value;
      var clothing  = document.getElementById('clothingItem').value;
     document.getElementById('Preview').src = "previews/" + clothing + inputText + ".png";
 }
  
  document.getElementById('clothingItem').onchange = (event) => {
     var inputText = event.target.value;
      var clothing  = document.getElementById('dyeColor').value;
     document.getElementById('Preview').src = "previews/" + inputText + clothing + ".png";
 }
