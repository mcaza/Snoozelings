...
<body>
    ...
    <div class="body-container">
        ...
        </div><?php require_once '../includes/guideColorCalculator.inc.php'; ?></div>
    </div>
...
<script>
     ...
     document.getElementById('one').onchange = (event) => {
     var inputText = event.target.value;
     document.getElementById('colorOne').src = "Layers/ColorPaws/" + inputText + ".png";
 }
     document.getElementById('two').onchange = (event) => {
     var inputText = event.target.value;
     document.getElementById('colorTwo').src = "Layers/ColorPaws/" + inputText + ".png";
 }
