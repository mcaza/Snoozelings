...
const face = ['Silly', 'Happy', 'Worried'];
...
function snoozeling() {
    ...
    if (this.mainColor === 'Retro' || this.mainColor === 'RedPanda' || this.mainColor === 'Bee' || this.mainColor === 'Raccoon' || this.mainColor === 'Sloth') {
        if (randomNum === 0) {
...
function snoozelingGenerate(number, snoozelingOne) {
    ...
    document.getElementById('pbhaircolor').innerHTML = "<strong>Hair Color: </strong>" + snoozelingOne.hairColor;
    document.getElementById('pbeyecolor').innerHTML = "<strong>Eye Color: </strong>" + snoozelingOne.eyeColor;
    document.getElementById('pbnosecolor').innerHTML = "<strong>Nose Color: </strong>" + snoozelingOne.nosecolor;
    document.getElementById('pbhairstyle').innerHTML = "<strong>Hair Style: </strong>" + snoozelingOne.hairType;
    document.getElementById('pbtailstyle').innerHTML = "<strong>Tail Type: </strong>" + snoozelingOne.tailType;
    specialMarkings(snoozelingOne);
    /*  
...
function runCode() {
    var testSnooze = new snoozeling();
    snoozelingGenerate('one', testSnooze);
    snoozelingGenerate('large', testSnooze);
}
